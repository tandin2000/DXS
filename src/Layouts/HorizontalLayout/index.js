...
// Import Data
import NavDataMain from "../LayoutMenuData";
import navdata from '../LayoutMenuDataCompany'
//i18n
import { withTranslation } from "react-i18next";

const HorizontalLayout = (props) => {
    const currentCompanyData = JSON.parse(sessionStorage.getItem("authUser"));
    const currentCompany = currentCompanyData.name
    let navData;
    if(currentCompany.toLowerCase() === "salcash"){
         navData = NavDataMain().props.children; 
    }else{
         navData = navdata().props.children;
    }
                                                            ...
                                                            {key % 2 === 0 ? (
                                                                <Col lg={4}>
                                                                    <ul className="nav nav-sm flex-column">
                                                                        <li className="nav-item">
                                                                            <Link to="/company-search" className="nav-link">Company Search</Link>
                                                                        </li>
                                                                    </ul>
                                                                </Col>
                                                            ) : (
