...
import { Row, Col, div, Card, Alert, Container, Input, Label, Form, FormFeedback } from "reactstrap";
                                ...
                                <Card className="mt-4">
                                    ...
                                    <div className="p-4">
                                        <div className="text-center mt-2">
                                            ...
                                            <p className="text-muted">Get free SalCash account now</p>
                                        </div>
                                        <div className="p-2 mt-4">
                                            <Form
                                                ...
                                                <div className="mb-4">
                                                    <p className="mb-0 fs-12 text-muted fst-italic">By registering you agree to the SalCash 
